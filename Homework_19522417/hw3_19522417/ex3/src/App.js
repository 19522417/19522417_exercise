    ...
    <div className="hem">
        ...
        <div className="wrapper">
            ...
            <div className="wrap-information">
                <h1 className="name">NGUYEN THANH TRUC</h1>
                ...
                <div className="wrap-input">
                    ...
                    <div className="wrap-inputinfor">
                        <p className="inputdob">October 28, 2001</p>
                        <p className="inputgender">Female</p>
                        <p className="inputphone">090 676 1126</p>
                        <p className="inputemail">19522417@gm.uit.edu.vn</p>
                        <p className="inputaddress">Tan Phu, Ho Chi Minh, Viet Nam</p>
                        <p className="inputwb">https://www.facebook.com/ahihihihihihihihihihihihi2810</p>
                    </div>
                </div>
            </div>
        </div>
        <div id="Objective" className="Object">
            ...
            <div className="ob-infor">
                <p>Programming Language: C++, C#, Oracle PL/SQL.</p>
                <p>Expertise: Unified Modeling Language.</p>
                <p>Language: English.</p>
                <p>Also I know a little bit of Chinese.</p>
            </div>
        </div>
        <div id="Education" className="education">
            ...
            <div id="Interest" className="interest">
                ...
                <p className="inter-infor">I love reading books, listening to music, watching movies and learning more about
                    another language.</p>
            </div>
            <div id="Skill" className="skill">
                ...
                <form action="https://github.com/19522417/Hw1_19522417.git">
